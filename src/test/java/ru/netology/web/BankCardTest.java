...
class BankCardTest {
    ...
    @Test
    void correctlyFilledInFullName()  {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Костеркина Анастасия");
    ...
    void incorrectlyFilledInFullName()  {
        ...
        driver.findElement(By.className("button")).click();
        String text = driver.findElement(By.cssSelector("[data-test-id='order-success']")).getText();
        assertEquals("Имя и Фамилия указаные неверно", text.trim());
    }
